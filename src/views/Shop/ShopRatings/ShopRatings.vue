	        ...
	        <ul>
	          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
	            ...
	            <div class="content">
	              ...
	              <div class="recommend">
	                <span class="iconfont icon-thumb_up" :class="rating.rateType===0 ? 'icon-thumb_up' : 'icon-icon_thumbs_down'"></span>
...
<script>
	...
	export default {
		...
		methods: {
			setSelectType(selectType) { // 切换需要看的评论类型
				this.selectType = selectType
			},
			toggleOnlyShowText() { // 切换控制是否只显示有文本的评论
        		...
        		.content {
        			position: relative;
          			...
          			.recommend {
          				line-height: 16px;
            			font-size: 0;
            			.icon-thumb_up, .icon-icon_thumbs_down, .item {
            				  display: inline-block;
				              margin: 0 8px 4px 0;
				              font-size: 9px;
            			}
